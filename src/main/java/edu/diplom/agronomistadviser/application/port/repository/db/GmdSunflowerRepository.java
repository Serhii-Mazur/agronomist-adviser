...
public interface GmdSunflowerRepository {

    List<DiseasePrediction> findAllByRegionIdAndDateTimeBetween(int regionId, LocalDateTime dateTimeStart, LocalDateTime dateTimeEnd);
